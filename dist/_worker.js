// dist/_worker.js (SP-Proxy-Pages Enterprise Edition v1.0.1)
"use strict";
...
async function handleRequest(request, env) {
    ...
    // Core Fix: 明确拦截针对 Raw 代码托管域以及纯文本文件的注入意图，确保源码文件原封不动下发
